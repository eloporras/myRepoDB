...
public interface RequestedItemDAO {
	...
	List<RequestedItem> getAllForOwnSiteAndStatus(int siteId, RequestedItemStatus status) throws SQLException;

	RequestedItem getByRequestId(int requestId) throws SQLException;
