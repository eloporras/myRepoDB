...
<div class="container">
	...
	<div class="list-group">
		...
		<c:if test="${hasFoodBank}">
			...
			<a href="/webreports/WebReportServlet?reportType=OUTS" class="list-group-item" role="button"><span class="glyphicon glyphicon-link" aria-hidden="true"></span> Outstanding Requests Report</a><br>
		</c:if>
		<h3 class="bg-primary" style="padding:5px 25px;">Miscellaneous</h3>
		<a href="/ViewItemsServlet?init=true" class="list-group-item" role="button"><span class="glyphicon glyphicon-link" aria-hidden="true"></span> Search Food Bank Items</a><br/>
