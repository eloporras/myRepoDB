...
<div class="container">
	...
	<div class="list-group">
		...
		<c:if test="${hasShelter}">
			...
			<a href="/ClientServlet?init=true&action=check-in&checkInType=SHELTER" class="list-group-item" role="button"><span class="glyphicon glyphicon-link" aria-hidden="true"></span> Check Client Into Shelter</a><br/>
		</c:if>
		<c:if test="${hasSoupKitchen}">
			...
			<a href="/ClientServlet?init=true&action=check-in&checkInType=SOUPKITCHEN" class="list-group-item" role="button"><span class="glyphicon glyphicon-link" aria-hidden="true"></span> Check Client Into Soup Kitchen</a><br/>		
		</c:if>
		<c:if test="${hasFoodBank}">
			...
			<a href="/jsp/reports/outstandingRequestsReport.jsp" class="list-group-item" role="button"><span class="glyphicon glyphicon-link" aria-hidden="true"></span> Outstanding Requests Report</a>
		</c:if>
		<c:if test="${hasFoodPantry}">
			<h3 class="bg-primary" style="padding:5px 25px;">Food Pantry</h3>
			<a href="/ClientServlet?init=true&action=check-in&checkInType=FOODPANTRY" class="list-group-item" role="button"><span class="glyphicon glyphicon-link" aria-hidden="true"></span> Check Client into Food Pantry</a><br/>	
		</c:if>
		...
		<a href="/ClientServlet?init=true&action=search" class="list-group-item" role="button"><span class="glyphicon glyphicon-link" aria-hidden="true"></span> Search for Client</a><br/>
		<a href="/AddClientServlet?init=false&action=NewClient" class="list-group-item" role="button"><span class="glyphicon glyphicon-link" aria-hidden="true"></span> Add New Client</a><br/>
