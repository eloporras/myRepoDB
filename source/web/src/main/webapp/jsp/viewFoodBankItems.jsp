			  ...
			  $.ajax({
			        ...
			        success: function(data, textStatus, xhr) {
			            if(xhr.responseText == "Success"){
							...
							$("#messagesarea").html("<p class='alert alert-danger' role='alert'><span class='glyphicon glyphicon-exclamation-sign' aria-hidden='true' style='color:red'></span> Request could not be added : " + xhr.responseText + "<br /></p>");
			            }
			        },
			        error: function(xhr, textStatus, errorThrown) {
						$("#messagesarea").html("<p class='alert alert-danger' role='alert'><span class='glyphicon glyphicon-exclamation-sign' aria-hidden='true' style='color:red'></span> Error adding request : " + errorThrown + "<br /></p>");
